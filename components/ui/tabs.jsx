...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center xl:bg-white justify-center rounded-[30px] dark:md:bg-secondary p-1 text-muted-foreground",
      className
    )}
    {...props} />
))
